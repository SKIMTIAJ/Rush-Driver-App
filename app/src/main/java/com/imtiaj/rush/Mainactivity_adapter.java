...
public class Mainactivity_adapter extends ArrayAdapter<CustomItem> {


    public Mainactivity_adapter(@NonNull Context context, @NonNull ArrayList<CustomItem> objects) {
